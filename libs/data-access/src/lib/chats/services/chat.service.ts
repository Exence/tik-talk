...
import {
  ...
  isNewWSMessage,
  isUnreadWSMessage
} from '../interfaces/chat-ws-type-guards'
import { Chat, DatedMessages, Message, MyChat } from '../interfaces/chat.interface'
...
export class ChatService {
  ...
  #updateActiveChatMessagesWithMessage(message: Message) {
    const messageDate =
      DateTime.fromFormat(message.createdAt, 'yyyy-MM-dd HH:mm:ss').toISODate() ?? 'No date'
